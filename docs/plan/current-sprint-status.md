...
- Authentication UI (Login/Register) connected to backend JWT
...
| F: Testing & Polish       | 🔵 Not Started | 0/3 pts  |
...
- [ ] B3: JWT token management (localStorage + refresh) (1 pt)
...
- [ ] F5: Component unit tests (60%+ coverage) (1 pt)
