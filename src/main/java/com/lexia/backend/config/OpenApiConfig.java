        ...
        private Info apiInfo() {
                return new Info()
                                ...
                                .description("""
                                                ...
                                                - **Course Management**: Create, update, delete, and publish courses (CONTENT_MANAGER role)
                                                - **Lesson Management**: Create, update, delete lessons with JSONB content (READING, LISTENING, QUIZ, SPEAKING)
                                                - **Course Search**: Advanced search with filters (CEFR level, title, publication status)
                                                - **AI-powered Learning Features**: (Coming in Sprint 3)
                                                ...
                                                ## Roles & Permissions
                                                - **USER**: Default role - can view published courses and manage own profile
                                                - **CONTENT_MANAGER**: Can create, update, delete, and publish courses/lessons
                                                ...
                                                ## Lesson Types & JSONB Content
                                                Lessons store structured content in JSONB format:
                                                - **READING**: Passages, comprehension questions, vocabulary
                                                - **LISTENING**: Audio URLs, transcripts, comprehension questions
                                                - **QUIZ**: Multiple-choice and fill-in-the-blank questions
                                                - **SPEAKING**: Role-play scenarios with AI evaluation (Coming soon)

                                                For detailed JSONB schemas, see DATABASE-SCHEMA.md section 2.3
                                                """)
                                .contact(apiContact())
                                .license(apiLicense());
        }
