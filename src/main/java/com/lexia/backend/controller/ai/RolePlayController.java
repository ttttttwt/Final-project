 ...
 * 
 * <p>Base path: /api/v1/ai/roleplay</p>
 * 
 * <p>Features:</p>
 * <ul>
 ...
 *     <ul>
 *       <li><b>Immersive</b>: Fast chat-only for fluency practice (&lt;1s response)</li>
 *       <li><b>Learning</b>: Chat with grammar/vocabulary feedback (&lt;3s response)</li>
 *     </ul>
 *   </li>
...
public class RolePlayController {
     ...
     * 
     * <p>Uses Google Gemini AI to generate a unique scenario based on CEFR level,
     * domain, and optional industry. Falls back to pre-seeded content if AI fails.</p>
     * 
    ...
    @Operation(
        summary = "Generate role-play scenario",
        description = "Uses AI to generate a unique role-play scenario based on CEFR level, domain, and industry. " +
    ...
    @ApiResponses(value = {
        @ApiResponse(
            ...
            content = @Content(
                ...
                schema = @Schema(implementation = RolePlayScenarioDTO.class),
                examples = @ExampleObject(name = "Generated Scenario", value = """
                    {
    ...
    @Operation(
        summary = "List role-play scenarios",
        description = "Returns all available role-play scenarios with pagination. " +
    ...
    @Operation(
        ...
        description = "Retrieves a specific role-play scenario by its ID."
    )
    @ApiResponses(value = {
    ...
    public ResponseEntity<RolePlayScenarioDTO> getScenario(
            @Parameter(description = "Scenario UUID") 
    ...
    @Operation(
        ...
        description = "Initiates a new role-play conversation for the specified scenario. " +
    ...
    @ApiResponses(value = {
        @ApiResponse(
            ...
            content = @Content(
                mediaType = "application/json",
                schema = @Schema(implementation = RolePlayConversationDTO.class),
                examples = @ExampleObject(name = "New Conversation", value = """
                    {
    ...
    @Operation(
        ...
        description = "Retrieves all role-play conversations for the authenticated user with pagination."
    )
    @ApiResponses(value = {
    ...
    public ResponseEntity<Page<RolePlayConversationDTO>> getUserConversations(
            ...
            @Parameter(description = "Page size (max 100)") 
            @RequestParam(defaultValue = "20") int size,
            @Parameter(description = "Filter by status (in_progress, completed, abandoned)") 
        ...
        Page<RolePlayConversationDTO> conversations = rolePlayService.getUserConversations(user.getId(), pageable, status);
    ...
    @Operation(
        ...
        description = "Retrieves a specific conversation with full message history."
    )
    @ApiResponses(value = {
    ...
    public ResponseEntity<RolePlayConversationDTO> getConversation(
            @AuthenticationPrincipal User user,
            @Parameter(description = "Conversation UUID") 
     ...
     * 
     * <p>Optimized for fluency practice with target latency &lt;1s (p95).
     * Returns AI response without grammar/vocabulary feedback.</p>
     * 
     * @param user the authenticated user
     * @param conversationId the conversation UUID
     ...
     */
    @PostMapping(value = "/conversations/{conversationId}/messages/immersive", 
                 produces = MediaType.APPLICATION_JSON_VALUE, 
                 consumes = MediaType.APPLICATION_JSON_VALUE)
    @Operation(
        summary = "Send immersive message",
        description = "Sends a message in immersive mode for fast conversation practice. " +
    ...
    @ApiResponses(value = {
        @ApiResponse(
            ...
            content = @Content(
                mediaType = "application/json",
                schema = @Schema(implementation = RolePlayMessageDTO.class),
                examples = @ExampleObject(name = "Immersive Response", value = """
                    {
                      "role": "ai",
     ...
     * 
     * <p>Provides AI response with grammar, vocabulary, and fluency feedback.
     * Target latency &lt;3s (p95). Recommended for A1-B1 learners.</p>
     * 
     * @param user the authenticated user
     * @param conversationId the conversation UUID
     * @param request the message content
     ...
     */
    @PostMapping(value = "/conversations/{conversationId}/messages/learning", 
                 produces = MediaType.APPLICATION_JSON_VALUE, 
                 consumes = MediaType.APPLICATION_JSON_VALUE)
    @Operation(
        summary = "Send learning message",
        description = "Sends a message in learning mode with detailed feedback. " +
    ...
    @ApiResponses(value = {
        @ApiResponse(
            responseCode = "200",
            description = "AI response with feedback received",
            content = @Content(
                mediaType = "application/json",
                schema = @Schema(implementation = RolePlayMessageDTO.class),
                examples = @ExampleObject(name = "Learning Response", value = """
                    {
                      "role": "ai",
     ...
     * Target first token latency &lt;500ms.</p>
     * 
     * @param user the authenticated user
     * @param conversationId the conversation UUID
     * @param request the message content
    ...
    @Operation(
        ...
        description = "Sends a message and streams the AI response in real-time via Server-Sent Events. " +
     ...
     * 
     * <p>Uses synchronous AI call with automatic fallback to pre-seeded responses
     * if AI fails. Suitable for offline-ready scenarios.</p>
     * 
     * @param user the authenticated user
     * @param conversationId the conversation UUID
     * @param request the message content
     ...
     */
    @PostMapping(value = "/conversations/{conversationId}/messages/fallback", 
                 produces = MediaType.APPLICATION_JSON_VALUE, 
                 consumes = MediaType.APPLICATION_JSON_VALUE)
    @Operation(
        summary = "Send message with fallback",
        description = "Sends a message with automatic fallback to pre-generated responses if AI fails. " +
     ...
     * 
     * <p>Calculates metrics (message count, word counts, duration) and
     * generates feedback summary for learning mode conversations.</p>
     * 
     * @param user the authenticated user
     * @param conversationId the conversation UUID
    ...
    @Operation(
        ...
        description = "Marks a conversation as complete and calculates final metrics. " +
    ...
    @ApiResponses(value = {
        @ApiResponse(
            ...
            content = @Content(
                mediaType = "application/json",
                schema = @Schema(implementation = RolePlayConversationDTO.class),
                examples = @ExampleObject(name = "Completed Conversation", value = """
                    {
                      "id": "660e8400-e29b-41d4-a716-446655440001",
                      "status": "completed",
                      "mode": "learning",
    ...
    public ResponseEntity<RolePlayConversationDTO> completeConversation(
        ...
        RolePlayConversationDTO conversation = rolePlayService.completeConversation(conversationId, user.getId());
