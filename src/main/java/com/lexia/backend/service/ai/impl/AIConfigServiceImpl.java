...
public class AIConfigServiceImpl implements AIConfigService {
    ...
    public void registerFeatureIfNotExists(String featureName) {
        ...
        if (!configRepository.existsById(enabledKey)) {
            ...
            configs.add(AIConfig.builder().configKey(enabledKey).configValue("true").isEncrypted(false).build());
            configs.add(AIConfig.builder().configKey("feature." + featureName + ".model").configValue("gemini-1.5-pro")
                    .isEncrypted(false).build());
            configs.add(AIConfig.builder().configKey("feature." + featureName + ".maxTokens").configValue("8000")
                    .isEncrypted(false).build());
            configs.add(AIConfig.builder().configKey("feature." + featureName + ".temperature").configValue("0.7")
                    .isEncrypted(false).build());
            configs.add(AIConfig.builder().configKey("feature." + featureName + ".dailyLimit").configValue("10")
                    .isEncrypted(false).build());
            ...
            if ("custom_materials".equals(featureName)) {
                ...
                configs.add(AIConfig.builder().configKey("feature." + featureName + ".max_pages").configValue("20")
                        .isEncrypted(false).build());
                configs.add(AIConfig.builder().configKey("feature." + featureName + ".monthly_limit").configValue("10")
                        .isEncrypted(false).build());
            }
    ...
    public PlanLimitsDTO getPlanLimits() {
        ...
        return PlanLimitsDTO.builder()
                .freeRoleplaySessions(Integer.parseInt(configMap.getOrDefault("quota.free.roleplaySessions",
                ...
                .freeGrammarExercises(Integer.parseInt(configMap.getOrDefault("quota.free.grammarExercises",
                ...
                .proRoleplaySessions(Integer.parseInt(configMap.getOrDefault("quota.pro.roleplaySessions",
                ...
                .proGrammarExercises(Integer.parseInt(configMap.getOrDefault("quota.pro.grammarExercises",
                ...
                .warningThresholdPercent((int) (Double.parseDouble(configMap.getOrDefault("quota.warningThreshold",
                        String.valueOf(quotaLimitsConfig.getWarningThreshold()))) * 100))
                .criticalThresholdPercent((int) (Double.parseDouble(configMap.getOrDefault("quota.criticalThreshold",
    ...
    private AIFeatureConfig getFeatureConfigFromMap(Map<String, String> configMap, String featureName) {
        ...
        config.setTemperature(
                Double.parseDouble(configMap.getOrDefault("feature." + featureName + ".temperature", "0.7")));
