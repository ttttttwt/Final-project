 ...
 * Provides methods for generating, retrieving, and evaluating grammar exercises.
 * 
 * <p>Features:</p>
 * <ul>
...
public interface GrammarExerciseService {
     ...
     * 
     * <p>The exercises are generated based on the specified grammar topic, CEFR level,
     * and optional theme. If AI generation fails, fallback content is used.</p>
     * 
     * @param request the exercise generation request containing grammar topic, CEFR level, etc.
     ...
     * @throws com.lexia.backend.exception.ResourceNotFoundException if grammar topic is not found
     */
     ...
     * Generates detailed feedback for each question.</p>
     * 
     * @param exerciseSetId the exercise set UUID
     * @param userId the user's UUID
     ...
     * @throws com.lexia.backend.exception.ResourceNotFoundException if exercise set not found
     * @throws IllegalStateException if already submitted by this user
     */
