 ...
 * Contains front (word/phrase), back (definition/details), tags, and difficulty.
 * 
 * @author LEXIA Team
 * @since Sprint 5
 */
...
public class FlashcardCardDTO implements Serializable {
    ...
    @Schema(description = "Front of card - word or phrase to learn",
            example = "collaborate", 
    ...
    @Schema(description = "Back of card - definition and learning details",
            requiredMode = Schema.RequiredMode.REQUIRED)
     ...
     */
    @Schema(description = "Difficulty level from 1 (easy) to 5 (hard)",
            example = "3",
            minimum = "1",
            maximum = "5")
    @Builder.Default
