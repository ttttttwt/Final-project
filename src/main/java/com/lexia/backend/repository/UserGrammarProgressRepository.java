 ...
 * Provides CRUD operations and custom queries for tracking user progress on
 * grammar exercises.
 * 
 * <p>
 * Features:
...
public interface UserGrammarProgressRepository extends JpaRepository<UserGrammarProgress, Long> {
       ...
       /**
        * Delete progress record for a specific user and exercise set.
        * Used for retry/reset functionality.
        * 
        * @param userId        user UUID
        * @param exerciseSetId exercise set UUID
        */
       void deleteByUserIdAndExerciseSet_Id(UUID userId, UUID exerciseSetId);
}
