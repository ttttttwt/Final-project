...
public enum EmailPriority {
    ...
    public static EmailPriority forEmailType(EmailType emailType) {
        return switch (emailType) {
            case EMAIL_VERIFICATION, PASSWORD_RESET, SECURITY_ALERT, ACCOUNT_DEACTIVATION -> CRITICAL;
            case WELCOME, COURSE_COMPLETED, CERTIFICATE_DELIVERY, STREAK_MILESTONE, LEVEL_UP, PASSWORD_CHANGED -> HIGH;
            case ENROLLMENT_CONFIRMATION, STREAK_REMINDER, STREAK_LOST, DEVICE_LOGIN -> NORMAL;
