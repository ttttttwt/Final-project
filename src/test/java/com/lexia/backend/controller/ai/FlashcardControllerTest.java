...
class FlashcardControllerTest {
                ...
                .cards(List.of(
                        FlashcardCardDTO.builder()
                                ...
                                .back(FlashcardBackDTO.builder()
                                        ...
                                        .exampleSentence("Let's review the agenda before the meeting.")
    ...
    class GetUserDecksTests {
        ...
        void getUserDecks_CapPageSize() throws Exception {
            ...
            verify(flashcardService).getUserDecks(eq(testUserId), argThat(pageable -> 
    ...
    class UpdateDeckTests {
        ...
        void updateDeck_Success() throws Exception {
            ...
            when(flashcardService.updateDeck(eq(testDeckId), any(UpdateFlashcardDeckDTO.class), eq(testUserId)))
            ...
            verify(flashcardService).updateDeck(eq(testDeckId), any(UpdateFlashcardDeckDTO.class), eq(testUserId));
        }
    }
    ...
    class SubmitReviewTests {
        ...
        void submitReview_Success() throws Exception {
            ...
            when(flashcardService.submitReview(eq(testDeckId), eq(testUserId), any(FlashcardReviewResultDTO.class)))
            ...
            verify(flashcardService).submitReview(eq(testDeckId), eq(testUserId), any(FlashcardReviewResultDTO.class));
        }
