...
class FileControllerTest {
    ...
    class UploadFileTests {
        ...
        void shouldUploadFileSuccessfully() throws Exception {
            ...
            when(fileStorageService.store(any(), eq(FileCategory.AVATAR), eq(userId))).thenReturn(fileEntity);
    ...
    class DeleteFileTests {
        ...
        void shouldDeleteFileWhenUserIsOwner() throws Exception {
            ...
            when(fileStorageService.isOwner(fileId, userId)).thenReturn(true);
        ...
        void shouldReturn403WhenUserIsNotOwner() throws Exception {
            ...
            when(fileStorageService.isOwner(fileId, userId)).thenReturn(false);
